...
export default function Page() {
    ...
    return (
        <section className="min-h-full flex flex-col lg:flex-row">
            {/* Carousel */}
            <div className="relative lg:w-1/2 lg:flex lg:items-center lg:mt-20 lg:h-full">
                    ...
                    <CarouselContent className="lg:flex lg:items-center">
                        {[1, 2, 3, 4, 5].map((element, index) => (
                            <CarouselItem key={index} className="flex items-center justify-center sm:basis-full md:basis-1/3 lg:basis-full">
                                <Image className="object-contain w-full md:w-full lg:w-2/3" src="/sara.svg" height={140} width={117} alt="/tests" />
                            </CarouselItem>
                        ))}
                    </CarouselContent>
            ...
            <div className="relative h-full lg:w-1/2">
                <div className="absolute lg:h-screen lg:px-12 lg:flex lg:flex-col lg:justify-center flex flex-col -top-3 rounded-t-2xl py-8 px-7 w-full">
                    ...
                    <div className="pt-10 flex flex-col gap-5 justify-between items-center w-full">
                        ...
                        <Button className="w-full py-6 bg-[#212529] -translate-y-2 lg:rounded-2xl lg:translate-y-0 lg:py-6 text-xl">Add to Card</Button>
                    </div>
                </div>
            </div>
        </section>
